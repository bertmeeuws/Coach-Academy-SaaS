        ...
        <div className="dashboard-section dashboard">
            ...
            <div className="todos rounded shadow padding">
                <div className="todos-header box-header">
                    ...
                    <span onClick={handleClick} className="button-add">+</span>
                </div>
                <ul>
                    <TodoItem/>
                    <TodoItem/>
            ...
            <div className="stats rounded shadow padding">
            ...
            <div className="inbox-grid">
                <p className="inbox-sender smalltext">SENDER</p><p className="inbox-subject smalltext">SUBJECT</p>
                <InboxItem/>
                <InboxItem/>
                <InboxItem/>
            </div>
